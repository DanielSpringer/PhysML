...
if __name__ == '__main__':
    print(__file__)
    verteval.predict_for_all_models('2_1_1_step', 32, 128000, 'run_results_2', 123)
    pred_path = Path('/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results_2/2_1_1_step_s128000/predictions')

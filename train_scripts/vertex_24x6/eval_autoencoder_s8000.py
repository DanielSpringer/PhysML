...
if __name__ == '__main__':
    ...
    # # 1-1
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/1_1_s8000'
    ...
    # # 1-2
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/1_2_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, encode_only=False,
    #                              train_mode=TrainerModes.SLURM)
    
    # 2-1-1
    save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/2_1_1_s8000'
    ...
    # 2-1-2
    save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/2_1_2_s8000'
    preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, 
                                 encode_only=False, subset_type=['afm', 'fm'], train_mode=TrainerModes.SLURM)

    # # 2-2-1
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/2_2_1_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, 
    #                              encode_only=False, subset_type=['sc', 'fm'], train_mode=TrainerModes.SLURM)

    # # 2-2-2
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/2_2_2_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, 
    #                              encode_only=False, subset_type=['sc', 'fm'], train_mode=TrainerModes.SLURM)

    # # 2-3-1
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/2_3_1_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, 
    #                              encode_only=False, subset_type=['afm', 'sc'], train_mode=TrainerModes.SLURM)

    # # 2-3-2
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/2_3_2_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, 
    #                              encode_only=False, subset_type=['afm', 'sc'], train_mode=TrainerModes.SLURM)

    # # 3-1
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/3_1_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, encode_only=False, subset_type='sc',
    #                              train_mode=TrainerModes.SLURM)

    # # 3-2
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/3_2_s8000'
    # preds = verteval.predict_all(file_paths, vertices, save_path, config_kwargs, dataset_kwargs, encode_only=False, subset_type='afm',
    #                              train_mode=TrainerModes.SLURM)

    # # 3-3
    # save_path = '/gpfs/data/fs71925/shepp123/PhysML/saves/vertex_24x6/run_results/3_3_s8000'
